...
#define MAX_CUSTOM_TABLE_SIZE 1114112
...
static int vty_bisearch(uint8_t ucs, const struct interval *table, int max) {
  int min = 0;
  int mid;
...
static int builtin_wcwidth(uint32_t ucs)
{
...
int vty_mk_wcwidth(uint32_t ch)
{
